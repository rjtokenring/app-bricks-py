...
def reset_pipewire_warning(monkeypatch):
    ...
    monkeypatch.setattr("arduino.app_peripherals.microphone.alsa_microphone._pipewire_warned", False)
...
def usb_cards(monkeypatch):
    ...
    def configure(*indexes):
        monkeypatch.setattr(
            "arduino.app_peripherals.microphone.alsa_microphone._is_usb_card",
